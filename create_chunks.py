...
from ai_embedding import get_embeddings,cosine_similarity
...
# 3. Create the chunks
def get_top_similar_chunks(text:str, query:str)->list[str]:
...
if __name__=="__main__":
  ...
  print(get_top_similar_chunks(text,query))